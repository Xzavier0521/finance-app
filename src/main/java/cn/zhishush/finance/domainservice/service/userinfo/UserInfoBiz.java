package cn.zhishush.finance.domainservice.service.userinfo;
...
public interface UserInfoBiz {
     ...
     * @param userId
     * @param pwd
     * @param mobileCode 如果是第一次设置，则不校验，否则会校验
     * @author hewenbin
     ...
     *
     * @param userId
     * @param maxCount 团队成员查询上限
     * @param type     0：全部，1：一级，2：二级
     * @return
     * @author hewenbin

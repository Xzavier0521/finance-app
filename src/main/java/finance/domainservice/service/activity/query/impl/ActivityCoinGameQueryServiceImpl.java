 ...
 *
 * @author lili
 * @version 1.0: ActivityCoinGameQueryServiceImpl.java, v0.1 2018/11/15 9:05 PM
 *          PM lili Exp $
 */
...
public class ActivityCoinGameQueryServiceImpl implements ActivityCoinGameQueryService {
	...
	@Override
	public List<CoinGame> queryCoinGameList(UserInfo userInfo, String activityCode, List<String> gameCodes) {
		...
		for (String gameCode : gameCodes) {
			...
			activityCoinGame = activityCoinGameRepository.queryByCondition(userInfo.getId(), activityCode, gameCode);

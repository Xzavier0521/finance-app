 ...
 *
 * @author lili
 * @version 1.0: RedEnvelopeRainDataRepositoryImpl.java, v0.1 2018/11/14 10:07
 *          PM PM lili Exp $
 */
@Slf4j
...
public class RedEnvelopeRainDataRepositoryImpl implements RedEnvelopeRainDataRepository {
	 ...
	 * 保存
	 *
	 * @param redEnvelopeRainData
	 *            记录
	 * @return int
	 */
	@Override
	public int save(RedEnvelopeRainData redEnvelopeRainData) {
		return redEnvelopeRainDataDAO.insertSelective(RedEnvelopeRainDataConverter.convert(redEnvelopeRainData));
	}
	 ...
	 */
	@Override
	public RedEnvelopeRainData queryTodayData(Long userId, String activityCode, Integer activityDay) {
	...
	public RedEnvelopeRainData queryHistoryData(Long userId, String activityCode) {
		return RedEnvelopeRainDataConverter.convert(redEnvelopeRainDataDAO.queryHistoryData(userId, activityCode));
	}
	...
	public Page<RedEnvelopeRainData> query4Page(Integer pageSize, Long pageNum, String activityCode,
		...
		if (count > 0) {
			...
			page.setDataList(RedEnvelopeRainDataConverter.convert2List(redEnvelopeRainDataDAO.query(parameters)));
		}
		return page;
	}
	...
	public Page<RedEnvelopeRainData> queryDailyRainData4Page(Integer pageSize, Long pageNum, String activityCode,
		...
		if (count > 0) {
			parameters.put("page", page);
			page.setDataList(
					RedEnvelopeRainDataConverter.convert2List(redEnvelopeRainDataDAO.queryDailyRainData(parameters)));
		}
		return page;
	}
	...
	public List<RedEnvelopeRainData> queryRankingList(String activityCode, Integer activityDay,
			RedEnvelopeRainTimeCodeEnum timeCode, int pageSize, int pageNum) {
		Map<String, Object> parameters = Maps.newHashMap();
		parameters.put("activityCode", activityCode);
		parameters.put("activityDay", activityDay);
		if (Objects.nonNull(timeCode)) {
		...
		parameters.put("page", page);
		return RedEnvelopeRainDataConverter.convert2List(redEnvelopeRainDataDAO.queryRankingList(parameters));
	}

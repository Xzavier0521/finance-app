...
import finance.ext.service.weixin.WeiXinQueryTokenService;
import finance.core.common.enums.CodeEnum;

/**
 * <p>微信接口调用获取</p>
 * @author lili
 * @version $Id: WeiXinQueryTokenClientImpl.java, v0.1 2018/10/21 8:49 PM lili Exp $
 */
@Slf4j
...
public class WeiXinQueryTokenClientImpl implements WeiXinQueryTokenClient {
    ...
    public WeiXinQueryTokenResponse getAccessToken(WeiXinQueryTokenRequest request) {
        ...
        try {
            response = create().getAccessToken(request.getAppid(), request.getAppsecret()).execute()
                .body();
            ...
            log.error("[获取微信access_token],请求参数:{},异常信息:{}", request,

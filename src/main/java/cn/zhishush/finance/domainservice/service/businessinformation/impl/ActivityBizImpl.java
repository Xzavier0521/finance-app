...
import cn.zhishush.finance.api.model.vo.activity.ActivityListVO;
import cn.zhishush.finance.api.model.vo.activity.StepRewardsDetailVo;
import cn.zhishush.finance.api.model.vo.activity.StepRewardsJoinDetailVo;
...
import cn.zhishush.finance.domainservice.service.businessinformation.ActivityBiz;

/**
 * <p>注释</p>
 *
 * @author lili
 * @version 1.0: ActivityBizImpl.java, v0.1 2018/12/7 1:06 AM lili Exp $
 */
@Service
public class ActivityBizImpl implements ActivityBiz {
    ...
    public StepRewardsDetailVo queryStepRewardsInfo(Long userId, Page<StepRewardsDetailVo> page) {
        ...
        Integer inviteNum = 0;
        if (userId != null) {
            stepRewardsActivity = activityMapper.selectOneByUserId(userId);
        }
        if (stepRewardsActivity == null) {
            ...
            if (rewardsActivityList != null && !rewardsActivityList.isEmpty()) {
                ...
                List<UserInfoDO> userInfos = userInfoMapper.selectByPrimaryKeys(joinUserIdList);
    ...
    public ResponseResult<Boolean> saveStepRewardsActivty(Long userId) {
        ...
        StepRewardsActivityDO existStepRewardsActivity = activityMapper.selectOneByUserId(userId);

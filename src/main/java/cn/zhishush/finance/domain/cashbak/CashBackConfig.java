package cn.zhishush.finance.domain.cashbak;
 ...
 * <p>返佣配置</p>
 * @author lili
 * @version 1.0: CashBackConfig.java, v0.1 2018/11/29 2:09 AM lili Exp $
 */
@Data
public class CashBackConfig implements Serializable {

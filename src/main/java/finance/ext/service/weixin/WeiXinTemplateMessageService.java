...
import finance.ext.api.request.WeiXinPrivateTemplateDelRequest;
import finance.ext.api.request.WeiXinQueryTemplateIdRequest;
import finance.ext.api.request.WeiXinSetIndustryRequest;
import finance.ext.api.request.WeiXinTemplateMessageSendRequest;
import finance.ext.api.response.*;
 ...
 *
 * @author lili
 * @version $Id: WeiXinTemplateMessageService.java, v0.1 2018/10/21 7:59 PM lili
 *          Exp $
 */
public interface WeiXinTemplateMessageService {
	...
	Call<WeiXinBasicResponse> setIndustry(@Query("access_token") String accessToken, WeiXinSetIndustryRequest request);

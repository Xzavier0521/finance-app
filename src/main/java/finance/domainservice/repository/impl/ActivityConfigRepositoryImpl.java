 ...
 * 
 * @author lili
 * @version $Id: ActivityConfigRepositoryImpl.java, v0.1 2018/10/11 10:16 AM
 *          lili Exp $
 */
...
public class ActivityConfigRepositoryImpl implements ActivityConfigRepository {
	...
	public int update(ActivityConfig activityConfig) {
		return activityConfigDAO.updateByPrimaryKeySelective(ActivityConfigConverter.convert(activityConfig));
	}

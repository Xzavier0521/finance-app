 ...
 * 
 * @author lili
 * @version $Id: InviteOpenInfoRepositoryImpl.java, v0.1 2018/10/31 11:10 PM
 *          lili Exp $
 */
@Slf4j
...
public class InviteOpenInfoRepositoryImpl implements InviteOpenInfoRepository {
	...
	public WeChatSubscribeInfo countSubscribeInfo(String inviteCode) {
		return WeChatSubscribeInfoConverter.convert(inviteOpenInfoDAO.countSubscribeInfo(inviteCode));
	}
	...
	public InviteOpenInfo queryInviteOpenInfo(String openId) {
		...
		List<InviteOpenInfo> inviteOpenInfoList = InviteOpenInfoConverter.convert2List(inviteOpenInfoDAO.query(param));

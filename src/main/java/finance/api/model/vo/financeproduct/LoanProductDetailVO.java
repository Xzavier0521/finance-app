...
public class LoanProductDetailVO {
    ...
    public String toString() {
        return "LoanProductDetailVO{" + "id=" + id + ", productName='" + productName + '\''
               + ", mark1='" + mark1 + '\'' + ", mark2='" + mark2 + '\'' + ", amountScope='"
               + amountScope + '\'' + ", dateScope='" + dateScope + '\'' + ", logoUrl='" + logoUrl
               + '\'' + ", terminalBonus='" + terminalBonus + '\'' + ", directBonus='" + directBonus
               + '\'' + ", indirectBonus='" + indirectBonus + '\'' + ", cashbackDate='"
               + cashbackDate + '\'' + ", redirectUrl='" + redirectUrl + '\'' + ", amountType='"
               + amountType + '\'' + ", productDesc='" + productDesc + '\'' + ", promotionUrl='"
               + promotionUrl + '\'' + '}';
    }
}

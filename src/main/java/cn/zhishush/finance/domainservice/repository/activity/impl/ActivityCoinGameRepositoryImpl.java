...
import cn.zhishush.finance.core.dal.dao.activity.ActivityCoinGameDAO;
import cn.zhishush.finance.domain.activity.ActivityCoinGame;
import cn.zhishush.finance.domainservice.converter.activity.ActivityCoinGameConverter;
 ...
 *
 * @author lili
 * @version 1.0: ActivityCoinGameRepositoryImpl.java, v0.1 2018/11/15 11:34 AM lili Exp $
 */
@Slf4j
...
public class ActivityCoinGameRepositoryImpl implements ActivityCoinGameRepository {
    ...
    public int save(ActivityCoinGame activityCoinGame) {
        return activityCoinGameDAO
            .insertSelective(ActivityCoinGameConverter.convert(activityCoinGame));
    }

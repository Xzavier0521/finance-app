...
import finance.ext.service.kameng.UserApplyCreditCardDetailService;
 ...
 *
 * @author liwei
 * @version $Id: UserApplyCreditCardDetailClientImpl.java, v0.1 2018/11/19 下午6:30 PM user Exp $
 */
@Slf4j
...
public class UserApplyCreditCardDetailClientImpl implements UserApplyCreditCardDetailClient {
    ...
    public KaMengUserApplyCreditCardResponse applyCreditCard(UserApplyCreditCardDetailDO userApplyCreditCardDetailDO) {
        ...
        try {
            ...
            log.error("[获取申请办理信用卡结果],请求参数:{},异常信息:{}", request,

...
public interface SmsValidateService {
	...
	/**
	 * 缓存短信验证码.
	 * @param mobileNum not null and ''
	 * @param smsCode not null and ''
	 * @return
	 * @author hewenbin
	 * @version SmsValidateService.java, v1.0 2018年7月10日 下午3:01:35 hewenbin
	 */
	Boolean cacheSmsVidateCode(String mobileNum, String vidateCode, String useType);
	 ...
	 */
	Boolean vidateSmsCode(String mobileNum, String smsCode, String type);

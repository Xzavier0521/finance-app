...
import finance.core.dal.dao.OperationLogDAO;
...
public class OperationLogRepositoryImpl implements OperationLogRepository {
	...
	public int save(OperationLog operationLog) {
		return financeOperationLogMapper.insertSelective(OperationLogConverter.convert(operationLog));
	}
	...
	public int batchSave(List<OperationLog> operationLogs) {
		return financeOperationLogMapper.batchInsert(OperationLogConverter.convert2DoList(operationLogs));
	}
	 ...
	 */
	@Override
	public List<OperationLog> queryLatestLog(Long parentUserId, List<String> opCodes, int pageNum, int pageSize) {

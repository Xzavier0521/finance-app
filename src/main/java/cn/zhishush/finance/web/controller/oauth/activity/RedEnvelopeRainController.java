...
import cn.zhishush.finance.api.model.request.RedEnvelopeRainUserDataRequest;
import cn.zhishush.finance.api.model.response.BasicResponse;
import cn.zhishush.finance.api.model.response.RedEnvelopeRainUserDataResponse;
...
import cn.zhishush.finance.api.model.vo.activity.UserRedEnvelopeRainInfoVO;
import cn.zhishush.finance.api.model.vo.activity.UserRedEnvelopeRainSummaryDataVO;
...
import cn.zhishush.finance.core.common.util.*;
import cn.zhishush.finance.domain.activity.RedEnvelopeRainData;
import cn.zhishush.finance.domain.activity.UserRedEnvelopeRainInfo;
import cn.zhishush.finance.domain.activity.UserRedEnvelopeRainSummaryData;
...
import cn.zhishush.finance.domainservice.service.activity.query.RedEnvelopeRainConfigQueryService;
...
import cn.zhishush.finance.web.controller.response.RedEnvelopeRainDataBuilder;
...
public class RedEnvelopeRainController {
    ...
    public ResponseResult<RedEnvelopeRainUserDataResponse> saveData(@RequestBody RedEnvelopeRainUserDataRequest request) {
        ...
        try {
            ...
            PreconditionUtils.checkArgument(request.getTotalAmount().longValue() <= 1000

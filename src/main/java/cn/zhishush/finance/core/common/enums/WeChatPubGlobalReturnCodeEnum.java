 ...
 *
 * @author lili
 * @version $Id: WeChatPubGlobalReturnCodeEnum.java, v0.1 2018/10/29 10:56 PM lili Exp $
 */
public enum WeChatPubGlobalReturnCodeEnum {
    ...
    INVALID_APP_ID("40013-不合法的AppID,请开发者检查 AppID 的正确性,避免异常字符,注意大小写", "40013"),
    ...
    MISSING_APP_ID_PARAMETER("41002-缺少 appid 参数", "41002"),
    ...
    USER_MODIFIED_WE_CHAT_PASSWORD("42007-用户修改微信密码， accesstoken 和 refreshtoken 失效，需要重新授权", "42007"),

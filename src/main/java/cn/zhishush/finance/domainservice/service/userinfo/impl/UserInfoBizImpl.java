...
import cn.zhishush.finance.core.dal.dao.user.UserPwdInfoDAO;
...
import cn.zhishush.finance.api.model.vo.userinfo.UserInfoDetailVo;
import cn.zhishush.finance.api.model.vo.userinfo.UserProfitInfoDetailVo;
...
import cn.zhishush.finance.domain.activity.LevelCount;
import cn.zhishush.finance.domain.dto.IdCardInfoDto;
import cn.zhishush.finance.domain.dto.UserBankCardDto;
import cn.zhishush.finance.domain.team.TeamInfoQueryResult;
import cn.zhishush.finance.domainservice.service.auth.AuthService;
import cn.zhishush.finance.domainservice.service.jwt.JwtService;
import cn.zhishush.finance.domainservice.service.user.query.TeamInfoQueryService;
...
public class UserInfoBizImpl implements UserInfoBiz {
    ...
    public ResponseResult<String> saveBankCard(UserBankCardDto bankCardDto) {
        ...
        // 检查本次要添加的银行卡是否存在
        UserBankCardInfoDO existCardInfo = bankCardInfoMapper.selectUserBankCard(userId, accountNo);
    ...
    public Map<String, Object> queryInviteList(Long userId, int maxCount, int type) {
        ...
        List<UserInviteInfoDO> firstLevels = inviteInfoMapper.selectByParentIds(rootParentIds, page,
            null);
        ...
        List<UserInviteInfoDO> secondLevels = inviteInfoMapper.selectByParentIds(firstLevelUserIds,
            page, null);

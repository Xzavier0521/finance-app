...
import cn.zhishush.finance.core.common.exception.ServiceException;
 ...
 * 
 * @author lili
 * @version $Id: ResponseUtils.java, v 0.1 2018年4月11日 上午10:22:14 lili Exp $
 */
public class ResponseUtils {
    ...
    public static void buildResult(BasicResponse response, ReturnCode returnCode) {
        response.setSuccess(ReturnCode.SUCCESS == returnCode);
        response.setReturnCode(returnCode.getCode());
        response.setReturnMessage(returnCode.getDesc());
    }
    ...
    public static BasicResponse buildResp(ReturnCode returnCode, String message) {
        ...
        basicResponse
            .setReturnMessage(StringUtils.isBlank(message) ? returnCode.getDesc() : message);

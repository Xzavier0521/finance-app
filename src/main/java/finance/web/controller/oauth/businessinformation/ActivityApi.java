...
public class ActivityApi {
    ...
    public ResponseResult<StepRewardsDetailVo> queryStepRewardsInfo(@RequestParam(name = "pageSize", defaultValue = "5") Integer pageSize,
        ...
        StepRewardsDetailVo stepRewardsDetailVo = activityBizImpl.queryStepRewardsInfo(userId,
            page);
    ...
    public ResponseResult<FixedAmountPageVO> fixedAmountPageInfo(@RequestParam("pageNum") Long pageNum,
        ...
        FixedAmountPageVO returnMap = inviteActivityService
            .queryFixedAmountPageInfo(fixedAmountPageDto);
        return ResponseResult.success(returnMap);
    }
    ...
    public ResponseResult<FixedAmountPageVO> fixedAmountJoinInfo() {
        ResponseResult<FixedAmountPageVO> returnMap = inviteActivityService
            .joinFixedAmountActivity();
        return returnMap;
    }
    ...
    public ResponseResult<ParticipantInfoVO> queryRedEnvelopDetail() {
        ...
        try {
            ...
            if (Objects.nonNull(userInfo)) {
                ...
                ParticipantInfo participantInfo = redEnvelopeRepository.querySingleDetail(userId,
                    "0001");

...
public interface RedEnvelopeDAO {
	 ...
	 */
	List<LeaderBoardDO> queryFirstRanking(@Param("activityCode") String activityCode, @Param("num") int num);
	 ...
	 * @return List<LeaderBoardDO>
	 */
	List<LeaderBoardDO> querySecondRanking(@Param("activityCode") String activityCode, @Param("num") int num);
	 ...
	 * @return List<LeaderBoardDO>
	 */
	List<LeaderBoardDO> queryTotalRanking(@Param("activityCode") String activityCode, @Param("num") int num);

...
public enum GameTaskType {
    everydaySign("1","每日签到"),
    newRegisterTask("2","新手任务"),
    groupTask("3","成长任务"),

    withdrawalTask("withdrawalTask","提现"),
    perfectInfoTask("perfectInfoTask","完善资料"),
    invitePerson("invitePerson","邀请有礼"),
	exchangeFee("exchangeFee","兑换手续费"); // 提现时，使用金币兑换手续费

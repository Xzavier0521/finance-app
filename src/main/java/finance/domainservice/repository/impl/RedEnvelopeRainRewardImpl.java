 ...
 *
 * @author lili
 * @version 1.0: RedEnvelopeRainRewardImpl.java, v0.1 2018/11/18 3:07 PM PM lili
 *          Exp $
 */
...
public class RedEnvelopeRainRewardImpl implements RedEnvelopeRainRewardRepository {
	...
	public int save(RedEnvelopeRainReward redEnvelopeRainReward) {
		return redEnvelopeRainRewardDAO.insertSelective(RedEnvelopeRainRewardConverter.convert(redEnvelopeRainReward));
	}

	@Override
	public RedEnvelopeRainReward queryByCondition(String activityCode, String activityDay,
			RedEnvelopeRainTimeCodeEnum timeCode, Long userId, RewardTypeEnum rewardType) {

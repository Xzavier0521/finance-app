 ...
 *
 * @author lili
 * @version 1.0: RedEnvelopeRainNoticeTask.java, v0.1 2018/11/20 6:34 PM PM lili
 *          Exp $
 */
@Slf4j
@Service
public class RedEnvelopeRainNoticeTask implements SchedulingConfigurer {
    ...
    public void configureTasks(ScheduledTaskRegistrar taskRegistrar) {
        /*
         * taskRegistrar.addTriggerTask(() -> { log.info("[开始同步红包雨活动-消息推送]，当前时间：{}",
         * LocalDateTime.now()); redEnvelopeRainNoticeService.process();
         * log.info("[结束同步红包雨活动-消息推送]，当前时间：{}", LocalDateTime.now()); }, triggerContext

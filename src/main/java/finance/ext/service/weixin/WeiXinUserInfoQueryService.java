 ...
 *
 * @author lili
 * @version $Id: WeiXinUserInfoQueryService.java, v0.1 2018/10/22 11:33 AM lili Exp $
...
public interface WeiXinUserInfoQueryService {
     ...
     * {"errcode":40013,"errmsg":"invalid appid"}
     *
     * @param accessToken 获取用户基本信息（包括UnionID机制）
     * @param openId 普通用户的标识，对当前公众号唯一
     * @param lang 返回国家地区语言版本，zh_CN 简体，zh_TW 繁体，en 英语
     * @return Call<WeiXinUserInfoDetail>
     */
    @GET("cgi-bin/user/info?lang=zh_CN")
    Call<WeiXinUserInfoDetail> queryUserInfo(@Query("access_token") String accessToken,

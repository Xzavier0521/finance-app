...
public class ThirdLoginParamDto {
    ...
    public Boolean validateParam() {
        // 公共验证
        if (StringUtils.isEmpty(channel) || StringUtils.isEmpty(zsAppId)
    ...
    public String toString() {
        return "ThirdLoginParamDto{" + "zsAppId='" + zsAppId + '\'' + ", osType='" + osType + '\''
               + ", channel='" + channel + '\'' + ", code='" + code + '\'' + ", openId='" + openId
               + '\'' + ", platformCode='" + platformCode + '\'' + ", platformDetail='"
               + platformDetail + '\'' + '}';
    }

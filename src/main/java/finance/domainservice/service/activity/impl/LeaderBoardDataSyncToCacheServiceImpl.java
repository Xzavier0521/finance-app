 ...
 * <p>注释</p>
 * @author lili
 * @version $Id: LeaderBoardDataSyncToCacheServiceImpl.java, v0.1 2018/10/26 5:12 PM lili Exp $
 */
@Slf4j
...
public class LeaderBoardDataSyncToCacheServiceImpl implements LeaderBoardDataSyncToCacheService {
     ...
     * 一级邀请人数排行榜
     * key                                    field   value
     * leader_board:0001:invite_numbers:first user_id  256
    ...
    private void process(Long userId, LeaderBoardTypeEnum leaderBoardType) {
        ...
        CompletableFuture.supplyAsync(() -> {
            ...
            // 排名
            String rankingKey = MessageFormat.format("{0}:{1}:{2}:{3}",
                RedEnvelopConstant.LEADER_BOARD, RedEnvelopConstant.ACTIVITY_CODE,
                RedEnvelopConstant.RANKING, leaderBoardType.getCode());

...
public enum ReturnCode {
    ...
    PARAM_OVER_LEN_LIMIT("0000013", "参数长度不合法"),
    SYSTEM_ERROR("9999999","网络返回错误"),
    // 用户登陆，注册错误码 1XXX
    USER_REGISTER_ERROR("1001", "用户注册失败"),
    LOGIN_PARAM_VALIDATE_INVALID("0101001", "登陆信息输入不合法"),
    LOGIN_IMG_VALIDATE_FAIL("0101002", "图片验证码不正确"),
    LOGIN_SMS_VALIDATE_FAIL("0101003", "短信验证码不正确或已超过3次"),
    GET_OPENID_FAIL("0101004", "获取第三方账号信息失败"),
    THIRD_LOGIN_VALIDATE_INVALID("0101005", "输入不合法"),
    THIRD_UNBIND_VALIDATE_INVALID("0101006", "输入不合法"),
    THIRD_ACCOUNT_EXIST("0101007", "该授权账号已被绑定"),
    THIRD_HAS_BINDING("0101008", "已绑定，不允许重复绑定"),
    IMG_VALIDATE_INVALID("0102001", "验证码输入不合法"),
    IMG_VALIDATE_FAIL("0102002", "图片验证码不正确"),
    ...
    ACCOUNT_PWD_SMS_VALIDATE_FAIL("0104002", "短信验证码不正确"),
    ACCOUNT_NOT_EXIST("0104003", "不支持的银行卡号"),
    ID_INFO_NOT_SAVE("0104004", "个人信息未完善"),
    ID_CARD_PARAM_INVALID("0104005","您输入的姓名或身份证账号有误，请检查后重新输入"),
    ID_AUTH_EXIST("0104006", "身份证已验证"),
    BANK_CARD_AUTH_ERROR("0104007","银行卡验证异常，请联系客服"),
    BANK_CARD_AUTH_DIFFER("0104008","您输入的信息银行校验未通过，请检查您的银行卡号和您的银行预留手机号是否有误"),
    ID_AUTH_BY_OTHERS_ERROR("0104009", "身份证已被其他用户验证，请联系客服"),
    BANK_CARD_HAS_VERIFY("0104010", "银行卡已验证，不可修改"),

    WITH_DRAW_PARAM_INVALID("0201000","提现输入不合法"),
    SEND_MSG_ERROR("0201001","短信发送失败"),
    BANK_CARD_NOT_EXIST("0201002","用户不存在"),
    EXTEND_WITH_DRAW_MONEY("0201003","超出可提现金额"),
    PWD_ERROR("0201004","提现密码不对"),
    LOW_WITH_DRAW_MONEY("0201005","提现金额必须大于10元"),
    ID_CARD_NOT_EXIST("0201006","个人身份证信息未完善"),
    //产品
    FINANCIAL_PARAM_NULL("0301001","理财查询参数错误"),
    CREDIT_CARD_PARAM_NULL("0302001","输入不合法"),

...
public class CreditCardProductListVO {
    ...
    public String toString() {
        return "CreditCardProductListVO{" + "id=" + id + ", productName='" + productName + '\''
               + ", logoUrl='" + logoUrl + '\'' + ", totalBonus=" + totalBonus + ", passRate='"
               + passRate + '\'' + ", rebackCashDesc='" + rebackCashDesc + '\'' + ", directBonus="
               + directBonus + ", indirectBonus=" + indirectBonus + '}';
    }
}

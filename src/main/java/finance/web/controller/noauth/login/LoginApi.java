...
public class LoginApi {
	...
	@PostMapping("login")
	public ResponseResult<Map<String, Object>> login(HttpServletRequest req, HttpServletResponse resp,
	...
	public ResponseResult<Map<String, Object>> thirdLogin(HttpServletRequest req, HttpServletResponse resp,
			@RequestBody XMap paramMap) {

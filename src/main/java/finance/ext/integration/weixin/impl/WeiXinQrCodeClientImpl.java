...
public class WeiXinQrCodeClientImpl implements WeiXinQrCodeClient {
     ...
     */
    @Override
    public WeiXinTempQrCreateResponse createTempQr(String accessToken, Long expireSeconds,
                                                   String sceneStr) {
        ...
        request.setAction_info(
            ActionInfo.builder().scene(Scene.builder().scene_str(sceneStr).build()).build());

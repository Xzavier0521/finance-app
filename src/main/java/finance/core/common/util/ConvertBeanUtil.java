...
public class ConvertBeanUtil {
    ...
    public static <T> T copyBeanProperties( Class source,
                                           Class<T> target, Object sourceObj,
    ...
    public static <T> List<T> copyListBeanPropertiesToList(List<?> sourceObjs, List<T> targets,
                                                           Class<T> targetType) {
